...
class Config:
    ...
    # Base de données SQLite locale par défaut
    SQLALCHEMY_DATABASE_URI = os.environ.get("MYTAKAFUL_DB_URI", "sqlite:///mytakaful.db")
    SQLALCHEMY_TRACK_MODIFICATIONS = False

    # Intégrations paiement (remplacez par vos clés réelles en prod)
    ...
    COMMISSION_RATE = float(os.environ.get("MYTAKAFUL_COMMISSION_RATE", "0.02"))
